<?php
/**
 * Template untuk Form Booking Inline
 */
...
<form id="rental-mobil-inline-booking-form" class="rental-mobil-booking-form">
    <input type="hidden" id="rental-mobil-inline-booking-kendaraan-id" name="kendaraan_id" value="<?php echo esc_attr($kendaraan_id); ?>">
    <input type="hidden" id="rental-mobil-inline-booking-kendaraan-title" name="kendaraan_title" value="<?php echo esc_attr(get_the_title($kendaraan_id)); ?>">
    ...
    ?>
        <div class="rental-mobil-form-group rental-mobil-field-width-<?php echo esc_attr($field_width); ?> <?php echo esc_attr($conditional_class); ?>" <?php echo $conditional_attrs; ?> <?php echo $conditional_style; ?>>
            <label for="rental-mobil-inline-booking-<?php echo esc_attr($field['id']); ?>">
            ...
            <?php switch ($field['type']) {
                ...
                case 'number':
                    ...
                    <input
                        ...
                        id="rental-mobil-inline-booking-<?php echo esc_attr($field['id']); ?>"
